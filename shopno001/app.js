...
function sendWhatsAppDirectOrder(existingOrder = null) {
  const brand = (window.BRANDS_CONFIG && window.BRANDS_CONFIG[currentBrand]) || window.BRANDS_CONFIG?.['muthu'] || { name: 'Get Pattas Kadai', themeColor: '#059669' };
  const brandColor = brand.themeColor || '#059669';
